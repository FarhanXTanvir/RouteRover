...
if (isset($_GET['update'])) {
  ...
  file_put_contents('../script/uniqueLocations', $jsonData);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <div class="container">
    <div>
      ...
      if (file_exists('../script/uniqueLocations')) {
        $count = 0;
        $uniqueValuesJson = json_decode(file_get_contents('../script/uniqueLocations.json'), true);
